...
class GerarPreOrder
    ...
    def teste(xmlpath)
    client = Savon.client(wsdl: 'http://10.113.146.14:3110/ProcessaPreOrder.asmx?wsdl')
    #puts client.operations
    #binding.pry
   # @xmlpath = Fixtures.instance.load_file('./fixtures/payloads/xml' + teste.xml)
    response = client.call(:criar_pedido_hybris, message:
